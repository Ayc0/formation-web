...
<CodeSurfer
  title="Il est possible de de rajouter des méthodes qui font être exécutées à des moments différents"
...
Toutes les méthodes avec **UNSAFE** ne devraient plus être utilisées car vont être supprimées avec React 17

export default SplitRight;

# Différentes méthodes disponibles

<LifeCycle style={{ maxHeight: "80vh" }} />
